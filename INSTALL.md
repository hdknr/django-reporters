# **django-reporters** Installation Instructions

This section contains information about 
how to download and install **django-reporters** in your system. 
...
inside the ** django-reporters ** distribution package. 
...
URL is https://github.org/hdknr/django-reporters


## Install

To install **django-reporters** from soruce code, use the provided installation script::
...
the `source code repository`_ using ``pip``::
    ...
    pip install -e git+https://github.org/hdknr/django-reporters

The above command will install the latest development release of **django-reporters**.
